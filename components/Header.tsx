    ...
    return (
        <header className="h-20 bg-slate-900 flex items-center justify-between px-10 relative overflow-hidden z-30 border-b border-white/5 no-print shrink-0">
            ...
            <div className="flex items-center gap-5 relative z-10">
                <div className="w-10 h-10 bg-gradient-to-tr from-emerald-600 to-emerald-400 rounded-xl flex items-center justify-center shadow-lg transition-transform hover:rotate-3 cursor-pointer">
